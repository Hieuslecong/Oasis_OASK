...
The final code-level acceptance run for implementation 2.0.1 is GitHub Actions **#161**: package install PASS, compile PASS, **47/47 pytest PASS**, and shell syntax PASS for every canonical runner.
